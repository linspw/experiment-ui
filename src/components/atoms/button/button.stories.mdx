  ...
  <Story name="Variantes">
    {{
        ...
        <div>
          ...
          <br>
          <h-button variant="contained" color="error">contained</h-button>
          <h-button variant="outlined" color="error">outlined</h-button>
          <h-button variant="text" color="error">text</h-button>
          <br>
