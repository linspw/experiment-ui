...
<Canvas>
  <Story name="Rounded">
    {{
        ...
        template: `
        <div>
          <h-button @click="action" rounded>Rounded</h-button>
          <h-button @click="action" :rounded="false">Not rounded</h-button>
        </div>
        `,
        methods: { action: action("clicked") }
    }}
...
<Canvas>
  <Story name="Loading">
    {{
        ...
        template: `
        <div>
          <h-button @click="action" loading>Loading</h-button>
        </div>
        `,
        methods: { action: action("clicked") }
    }}
...
<Canvas>
  <Story name="Acessibilidade">
    {{
        ...
        template: `
        <div>
          <h-button accessible>is-accessible</h-button>
        </div>
        `,
        methods: { action: action("clicked") }
    }}
...
<Canvas>
  <Story name="Behavior">
    {{
        ...
        template: `
        <div>
          <h-button @click="action" block>Behavior</h-button>
        </div>
        `,
        methods: { action: action("clicked") }
    }}
